...
3. [RESTful API description and testing tools](chapters/03-restful-api-description-and-testing-tools.md)
	...
	4. [Differences between RESTful API testing and software testing in general](chapters/03-restful-api-description-and-testing-tools.md#differences-between-restful-api-testing-and-software-testing-in-general)
